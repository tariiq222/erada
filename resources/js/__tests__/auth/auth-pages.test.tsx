...
// Mock AuthContext - default to not authenticated
...
describe('Login Page', () => {
  ...
  it('renders system name', () => {
    render(<Login />);
    // System name appears twice - in header and footer
    const systemNames = screen.getAllByText(/منصة إرادة/);
  ...
  it('has submit button type', () => {
    render(<Login />);
    const submitButton = screen.getByRole('button', { name: /دخول/i });
