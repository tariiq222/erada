...
vi.mock('@pages/tasks/form', () => ({
  ...
  ProjectMilestoneSection: () => <div data-testid="project-milestone-section">Project Milestone Section</div>,
  TaskDetailsSection: () => <div data-testid="task-details-section">Task Details Section</div>,
  StatusScheduleSection: () => <div data-testid="status-schedule-section">Status Schedule Section</div>,
  TaskTypeSection: () => <div data-testid="task-type-section">Task Type Section</div>,
}));
...
describe('TaskForm Component', () => {
  ...
  it('renders in create mode', async () => {
    ...
    await waitFor(() => {
      const headings = screen.getAllByText('إنشاء مهمة جديدة');
  ...
  it('renders page description in create mode', async () => {
    render(<TaskForm />);
  ...
  it('renders task icon in header', async () => {
    render(<TaskForm />);

    await waitFor(() => {
      // Header icon is now IconClipboardCheck rendered via PageHeader.
      const headerIcon = document.querySelector('svg.tabler-icon-clipboard-check');
...
describe('TaskForm Sections', () => {
  it('renders task type section', async () => {
    render(<TaskForm />);
  ...
  it('renders project milestone section for project tasks', async () => {
    render(<TaskForm />);
  ...
  it('renders task details section', async () => {
    render(<TaskForm />);
  ...
  it('renders status schedule section', async () => {
    render(<TaskForm />);
...
describe('TaskForm Actions', () => {
  ...
  it('cancel button links to tasks list', async () => {
    render(<TaskForm />);
...
describe('TaskForm Form Structure', () => {
  ...
  it('renders card container', async () => {
    ...
    await waitFor(() => {
      // The Card component wraps the form content
      const cardContent = document.querySelector('.p-5');
  ...
  it('renders section dividers', async () => {
    ...
    await waitFor(() => {
      const dividers = document.querySelectorAll('.border-t.border-\\[var\\(--border-default\\)\\]');
...
describe('TaskForm Header', () => {
  it('renders header with title', async () => {
    ...
    await waitFor(() => {
      ...
      expect(heading?.textContent).toContain('إنشاء مهمة جديدة');
    });
  });
