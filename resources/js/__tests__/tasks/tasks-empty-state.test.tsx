...
vi.mock('@tabler/icons-react', async () => {
  ...
  IconListCheck: () => <span data-testid="list-checks-icon">ListChecks</span>,
...
import TasksEmptyState from '@pages/projects/components/sections/tasks/TasksEmptyState';

describe('TasksEmptyState Component', () => {
  const defaultProps = {
    onCreateTask: vi.fn(),
  };
  ...
  it('renders card component', () => {
    render(<TasksEmptyState {...defaultProps} />);
    expect(screen.getByTestId('card')).toBeInTheDocument();
  });

  it('renders list checks icon', () => {
    render(<TasksEmptyState {...defaultProps} />);
    expect(screen.getByTestId('list-checks-icon')).toBeInTheDocument();
  });

  it('shows no tasks title', () => {
    render(<TasksEmptyState {...defaultProps} />);
  ...
  it('shows empty state description', () => {
    render(<TasksEmptyState {...defaultProps} />);
    expect(screen.getByText('ابدأ بإضافة مهمة جديدة لهذا المشروع')).toBeInTheDocument();
  });
