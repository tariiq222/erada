...
import DeleteDepartmentModal from '@pages/hr/components/DeleteDepartmentModal';
...
describe('DeleteDepartmentModal Basic', () => {
  const defaultProps = {
    isOpen: true,
  ...
  it('renders modal when open', () => {
    render(<DeleteDepartmentModal {...defaultProps} />);
    expect(screen.getByRole('dialog')).toBeInTheDocument();
  });

  it('does not render when closed', () => {
    render(<DeleteDepartmentModal {...defaultProps} isOpen={false} />);
  ...
  it('shows department name in message', () => {
    render(<DeleteDepartmentModal {...defaultProps} />);
...
describe('DeleteDepartmentModal Buttons', () => {
  const defaultProps = {
    isOpen: true,
    department: mockDepartment,
    isDeleting: false,
...
describe('DeleteDepartmentModal Loading State', () => {
  const defaultProps = {
    isOpen: true,
    department: mockDepartment,
    isDeleting: true,
...
describe('DeleteDepartmentModal Null Department', () => {
  const propsWithNullDepartment = {
    isOpen: true,
    department: null,
    isDeleting: false,
    onClose: vi.fn(),
  ...
  it('does not render when department is null', () => {
    render(<DeleteDepartmentModal {...propsWithNullDepartment} />);
    expect(screen.queryByRole('dialog')).not.toBeInTheDocument();
  });
